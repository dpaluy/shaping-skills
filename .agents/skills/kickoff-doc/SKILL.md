---
name: kickoff-doc
description: Use when the user has a shaped-project kickoff transcript and wants a builder-facing reference document organized by system area rather than meeting timeline.
---
