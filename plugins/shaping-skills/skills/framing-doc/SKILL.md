---
name: framing-doc
description: Use when the user has conversation transcripts and wants a framing document that captures the problem worth solving, the evidence, and why this problem is prioritized now.
---
...
Use the supplied transcripts and topic. Ask only for missing information needed to identify the sources or scope:
